...
router.get(
  '/categories',
  authenticateToken,
  recipeController.getCategories.bind(recipeController),
);
router.get(
  '/category/:category',
  authenticateToken,
  recipeController.getRecipesByCategory.bind(recipeController),
);
router.patch(
  '/:id/categories',
  authenticateToken,
  recipeController.updateRecipeCategories.bind(recipeController),
);
